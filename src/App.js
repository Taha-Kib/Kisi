...
export default function App() {
  ...
  */
  ...
  /*Configurations for InterSectionObserverApi. Rootmargin is used to expand or shrink the 
  ...
  */
  ...
  /*  This useeffect hook is for intersection observerApi to load iamges when they come into view
      We use Intersectionobserver in useEffect to ensure that the observer is created and starts observing the target elements(images) when the component mounts
      It fires the callback if target element intersects with viewport. If so, it calls loadImages and unobserves the element.
      We are observering all images with attribute: data-src
      The return statement is for cleanup to unobserve all images when component is unmounted.
  */
  useEffect(() => {
  ...
  //This function takes the actual src from data-src of the image and copies it into src so it renders.
        ...
        >
          ...
          <div className="fullScreenImage">
            <img
              ...
              src={photos[slideNumber].urls["thumb"]}
              alt=""
            />
            <img
              style={{ display: fullImageLoaded ? "block" : "none" }}
              src={photos[slideNumber].urls[size]}
              alt=""
              onLoad={() => {
